...
@router.get("/opties", response_model=KoppelingOpties)
async def koppeling_opties(
    _user: AuthenticatedUser = Depends(vereist_permissie(Entiteit.KOPPELING, Actie.LEZEN)),
):
