...
// Basisstructuur — geen applicatie-views. Module-routes worden toegevoegd
// onder modules/<module>/frontend en hier geregistreerd tijdens V001.
// Placeholder-componenten houden de router zelfstandig (geen ontbrekende imports).
